    ...
    <div className="app-shell">
      ...
      <header className="site-header">
        <a href="#inicio" className="brand">
          ...
          >
            <svg viewBox="0 0 104 104" width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg">
              <defs>
              ...
              <path d="M30 30 L16 52 L30 74" stroke="url(#lg)" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M74 30 L88 52 L74 74" stroke="url(#lg)" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round" />
              <line x1="62" y1="26" x2="42" y2="78" stroke="#22D3EE" strokeWidth="6" strokeLinecap="round" />
              <circle cx="90" cy="18" r="10" fill="#6C63FF" />
              <circle cx="90" cy="18" r="5" fill="#22D3EE" />
            </svg>
          </div>
          <div style={{ lineHeight: 1.1 }}>
            <span style={{ display: "block", fontSize: 10, letterSpacing: 3, color: "#94A3B8", fontWeight: 400 }}>
              PROF
            </span>
      ...
      <main>
        ...
        <section id="inicio" className="section hero section-hero">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <a href="#metodo" className="button button-primary">{t.ctaPrimary}</a>
              <a href="#tecnologias" className="button button-secondary">{t.ctaSecondary}</a>
            </div>
          ...
          <div className="hero-visual">
            <div className="card-visual">
              <svg viewBox="0 0 680 480" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <rect x="120" y="60" width="440" height="300" rx="18" fill="#1E293B" />
                <rect x="134" y="74" width="412" height="272" rx="10" fill="#0F172A" />
                <rect x="134" y="74" width="412" height="22" rx="6" fill="#1E293B" />
                <circle cx="150" cy="85" r="5" fill="#EF4444" />
                <circle cx="165" cy="85" r="5" fill="#F59E0B" />
                <circle cx="180" cy="85" r="5" fill="#22C55E" />
                <rect x="220" y="80" width="100" height="10" rx="5" fill="#334155" />
                <rect x="158" y="100" width="60" height="10" rx="5" fill="#818CF8" />
                <rect x="226" y="100" width="90" height="10" rx="5" fill="#34D399" />
                <rect x="324" y="100" width="50" height="10" rx="5" fill="#64748B" />
                <rect x="170" y="122" width="80" height="10" rx="5" fill="#F472B6" />
                <rect x="258" y="122" width="110" height="10" rx="5" fill="#FBBF24" />
                <rect x="376" y="122" width="40" height="10" rx="5" fill="#64748B" />
                <rect x="182" y="144" width="60" height="10" rx="5" fill="#34D399" />
                <rect x="250" y="144" width="70" height="10" rx="5" fill="#818CF8" />
                <rect x="328" y="144" width="55" height="10" rx="5" fill="#F472B6" />
                <rect x="182" y="166" width="40" height="10" rx="5" fill="#FBBF24" />
                <rect x="230" y="166" width="100" height="10" rx="5" fill="#64748B" />
                <rect x="170" y="188" width="50" height="10" rx="5" fill="#818CF8" />
                <rect x="228" y="188" width="85" height="10" rx="5" fill="#34D399" />
                <rect x="321" y="188" width="60" height="10" rx="5" fill="#64748B" />
                <rect x="158" y="210" width="70" height="10" rx="5" fill="#F472B6" />
                <rect x="236" y="210" width="55" height="10" rx="5" fill="#818CF8" />
                <rect x="182" y="232" width="90" height="10" rx="5" fill="#FBBF24" />
                <rect x="280" y="232" width="75" height="10" rx="5" fill="#34D399" />
                <rect x="182" y="254" width="60" height="10" rx="5" fill="#64748B" />
                <rect x="250" y="254" width="110" height="10" rx="5" fill="#F472B6" />
                <rect x="158" y="276" width="3" height="14" rx="1" fill="#818CF8" opacity="0.9" />
                <rect x="315" y="360" width="50" height="24" rx="4" fill="#334155" />
                <rect x="270" y="384" width="140" height="10" rx="5" fill="#475569" />
                <rect x="60" y="90" width="54" height="54" rx="14" fill="#F7DF1E" />
                <text x="87" y="126" textAnchor="middle" fontFamily="monospace" fontWeight="700" fontSize="20" fill="#1E1E1E">JS</text>
                <circle cx="600" cy="120" r="30" fill="#1E293B" stroke="#61DAFB" strokeWidth="2.5" />
                <text x="600" y="126" textAnchor="middle" fontFamily="monospace" fontWeight="700" fontSize="13" fill="#61DAFB">React</text>
                <rect x="55" y="250" width="60" height="32" rx="10" fill="#3776AB" />
                <text x="85" y="271" textAnchor="middle" fontFamily="monospace" fontWeight="700" fontSize="12" fill="#FFD343">Python</text>
                <rect x="590" y="220" width="50" height="50" rx="12" fill="#3178C6" />
                <text x="615" y="254" textAnchor="middle" fontFamily="monospace" fontWeight="700" fontSize="20" fill="#FFFFFF">TS</text>
                <rect x="580" y="310" width="60" height="30" rx="10" fill="#3C873A" />
                <text x="610" y="330" textAnchor="middle" fontFamily="monospace" fontWeight="700" fontSize="12" fill="#FFFFFF">Node</text>
                <rect x="60" y="320" width="60" height="30" rx="10" fill="#E34F26" />
                <text x="90" y="340" textAnchor="middle" fontFamily="monospace" fontWeight="700" fontSize="12" fill="#FFFFFF">HTML</text>
              ...
              <div className="visual-bubble">Aprenda com exemplos práticos e objetivos.</div>
            </div>
          </div>
        </section>
            ...
            <article className="info-card">
              <div className="icon icon-code" aria-hidden="true">
                <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16 14L8 24L16 34" stroke="#4F46E5" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M32 14L40 24L32 34" stroke="#4F46E5" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M24 10H16C12.6863 10 10 12.6863 10 16V32C10 35.3137 12.6863 38 16 38H24" stroke="#4F46E5" strokeWidth="4" strokeLinecap="round" />
                </svg>
              </div>
              <h3>Aprenda com foco</h3>
              <p>Materiais estruturados em ciclos de aprendizado rápido para você avançar com segurança.</p>
            </article>

            <article className="info-card">
              <div className="icon icon-light" aria-hidden="true">
                <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M24 15C19.5817 15 16 18.5817 16 23C16 25.7665 17.2314 28.2684 19.2856 30.0788C20.3735 31.0104 21 32.3728 21 33.8824V36H27V33.8824C27 32.3728 27.6265 31.0104 28.7144 30.0788C30.7686 28.2684 32 25.7665 32 23C32 18.5817 28.4183 15 24 15Z" stroke="#10B981" strokeWidth="4" />
                  <path d="M24 38V44" stroke="#10B981" strokeWidth="4" strokeLinecap="round" />
                </svg>
              </div>
              <h3>Conteúdo relevante</h3>
              <p>Você encontra os conceitos certos para evoluir de forma prática e aplicável no mercado.</p>
            </article>
            ...
            <article className="info-card">
              <div className="icon icon-rocket" aria-hidden="true">
                <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M24 8C18 8 13.5 11.9 12 17.3C10.8 21.4 11.7 26.3 13.9 30.1L24 44L34.1 30.1C36.3 26.3 37.2 21.4 36 17.3C34.5 11.9 30 8 24 8Z" stroke="#F97316" strokeWidth="4" strokeLinejoin="round" />
                  <circle cx="24" cy="20" r="4" fill="#F97316" />
                </svg>
              </div>
              <h3>Impacto real</h3>
              <p>Estude tecnologias que são usadas em projetos reais do mercado atual.</p>
            </article>

            <article className="info-card">
              <div className="icon icon-support" aria-hidden="true">
                <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M24 12C17.3726 12 12 17.3726 12 24C12 30.6274 17.3726 36 24 36C30.6274 36 36 30.6274 36 24C36 17.3726 30.6274 12 24 12Z" stroke="#38BDF8" strokeWidth="4" />
                  <path d="M24 18V24" stroke="#38BDF8" strokeWidth="4" strokeLinecap="round" />
                  <path d="M24 28H24.01" stroke="#38BDF8" strokeWidth="4" strokeLinecap="round" />
                </svg>
              </div>
              <h3>Suporte contínuo</h3>
              <p>Aprenda com acompanhamento e suporte constante, para avançar sem perder o foco.</p>
            </article>
          </div>
        </section>
        ...
        <section id="tecnologias" className="section section-tecnologias">
          ...
          <div className="tech-stack-grid">
            {[
              { label: "JavaScript", description: "Linguagem essencial para o front-end moderno." },
              { label: "TypeScript", description: "Tipagem que deixa o código mais confiável." },
              { label: "HTML", description: "Estrutura e semântica para páginas acessíveis." },
              { label: "CSS", description: "Design visual com estilos profissionais." },
              { label: "TailwindCSS", description: "UI rápida e moderna com utilitários." },
              { label: "React", description: "Construção de interfaces reativas e escaláveis." },
              { label: "React Native", description: "Apps móveis nativos com a mesma base web." },
              { label: "Python", description: "Linguagem versátil para scripts, automação e ciência de dados." },
              { label: "Node", description: "Plataforma de desenvolvimento ágil para APIs e serviços." },
              { label: "Express", description: "Servidor web simples e flexível para rotas e APIs." },
              { label: "TypeORM", description: "ORM para organizar dados com TypeScript." },
              { label: "MySQL", description: "Banco relacional usado em projetos empresariais." },
              { label: "MongoDB", description: "Banco NoSQL ideal para dados flexíveis." },
              { label: "PHP", description: "Plataforma popular para back-end e sites dinâmicos." },
              { label: "Java", description: "Linguagem robusta para sistemas de grande porte." },
              { label: "C#", description: "Desenvolvimento profissional em apps e jogos." },
            ].map((tech) => (
              <a
                key={tech.label}
                className="tech-pill"
