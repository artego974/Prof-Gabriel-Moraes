...
function App() {
  ...
  return (
    <div className="app-shell">
      ...
      <header className="site-header flex items-center justify-between gap-6 py-5 bg-slate-950/80 backdrop-blur-xl border-b border-white/10">
        <a href="#inicio" className="brand flex items-center gap-4 text-white">
          {/* Ícone da logo */}
          <div
            style={{
              background: "#0F172A",
        ...
        <nav
          className="main-nav flex gap-6 items-center"
          aria-label="Menu principal"
        >
          <a href="#inicio" className="text-slate-200 hover:text-accent">
            {t.navHome}
          </a>
          <a href="#metodo" className="text-slate-200 hover:text-accent">
            {t.navMethod}
          </a>
          <a href="#tecnologias" className="text-slate-200 hover:text-accent">
            {t.navTech}
          </a>
          <a href="#contato" className="text-slate-200 hover:text-accent">
            {t.navContact}
          </a>
        </nav>
        ...
        <button
          type="button"
          className="button button-sm button-lang px-3 py-2 bg-slate-900/90 text-white border-white/10 rounded-full"
      ...
      <main>
        <section
          id="inicio"
          className="hero section section-hero grid md:grid-cols-[1.15fr_1fr] gap-12 items-center min-h-[calc(100vh-92px)] py-6"
        >
          <div className="hero-copy">
            ...
            <p className="hero-text text-slate-300 max-w-3xl mt-4">
              {t.heroText}
            </p>
            ...
            <div className="hero-actions">
              <a
                href="#metodo"
                className="button button-primary inline-flex items-center px-6 py-3 rounded-full"
              >
                {t.ctaPrimary}
              </a>
              <a
                href="#tecnologias"
                className="button button-secondary inline-flex items-center px-5 py-3 rounded-full"
              >
                {t.ctaSecondary}
              </a>
            </div>
        ...
        <section id="metodo" className="section section-grid">
          ...
          <div className="grid-cards grid grid-cols-1 md:grid-cols-4 gap-6">
            <article className="info-card bg-slate-950 border-slate-800 rounded-2xl p-6 shadow-md">
              <div
                className="icon icon-code w-16 h-16 grid place-items-center rounded-lg border p-2"
                aria-hidden="true"
              >
                <svg
                  viewBox="0 0 48 48"
              ...
              <h3 className="mt-4 text-lg font-semibold">Aprenda com foco</h3>
            ...
            <article className="info-card bg-slate-950 border-slate-800 rounded-2xl p-6 shadow-md">
              <div
                className="icon icon-light w-16 h-16 grid place-items-center rounded-lg border p-2"
                aria-hidden="true"
              >
                <svg
                  viewBox="0 0 48 48"
              ...
              <h3 className="mt-4 text-lg font-semibold">Conteúdo relevante</h3>
              <p className="text-slate-300 mt-2">
            ...
            <article className="info-card bg-slate-950 border-slate-800 rounded-2xl p-6 shadow-md">
              <div
                className="icon icon-rocket w-16 h-16 grid place-items-center rounded-lg border p-2"
                aria-hidden="true"
              >
                <svg
                  viewBox="0 0 48 48"
              ...
              <h3 className="mt-4 text-lg font-semibold">Impacto real</h3>
              <p className="text-slate-300 mt-2">
            ...
            <article className="info-card bg-slate-950 border-slate-800 rounded-2xl p-6 shadow-md">
              <div
                className="icon icon-support w-16 h-16 grid place-items-center rounded-lg border p-2"
                aria-hidden="true"
              >
                <svg
                  viewBox="0 0 48 48"
              ...
              <h3 className="mt-4 text-lg font-semibold">Suporte contínuo</h3>
              <p className="text-slate-300 mt-2">
        ...
        <section id="tecnologias" className="section section-tecnologias">
          ...
          <div className="tech-stack-grid grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              {
                label: "JavaScript",
              ...
              >
                ...
                <span className="tech-action inline-block mt-4 text-sm font-bold text-amber-700">
                  {t.cardAction}
                </span>
              </a>
            ))}
        ...
        <section className="section section-path">
          ...
          <div className="path-list grid gap-4">
            {[
              ...
              <article
                key={num}
                className="grid grid-cols-[56px_1fr] gap-4 p-6 bg-slate-950 border-slate-800 rounded-2xl shadow-md"
                  ...
                  {i < 2 && (
                    <div
                      style={{
                        ...
                        marginTop: 8,
                        background:
                          "linear-gradient(to bottom, #6C63FF, #22D3EE)",
                        borderRadius: 2,
                        opacity: 0.35,
                      }}
                    />
      ...
      <footer className="site-footer flex flex-wrap items-center justify-between py-6 px-8 border-t mt-6">
        <p className="text-slate-300">{t.footerText}</p>
        <div className="footer-links flex gap-4">
          <a href="#inicio" className="text-slate-300 hover:text-accent">
            {t.navHome}
          </a>
          <a href="#metodo" className="text-slate-300 hover:text-accent">
            {t.navMethod}
          </a>
          <a href="#tecnologias" className="text-slate-300 hover:text-accent">
            {t.navTech}
          </a>
        </div>
      </footer>
